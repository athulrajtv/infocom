    ...
    <div class="col-lg-8 mx-auto">
      ...
      <div class="card">
        ...
        <div class="card-body p-4">
          <form id="jQueryValidationForm" method="post" action="{{ route('admin.Image.create') }}" enctype="multipart/form-data">
            @csrf

            <div class="row mb-3">
                
                <div class="col-sm-9">
                    <input type="hidden" class="form-control" id="input41" placeholder="Tile" name="gallery_id" value="{{ $item->id }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="input41" placeholder="Tile" name="title" value="{{ $item->title }}">
                    @error('title')
      ...
      <div class="table-responsive mt-3">
        <table class="table align-middle">
          ...
          <tr>
              ...
              <td>
                <a href="{{ route('admin.Image.delete', $data->id) }}" class="btn btn-danger">Delete</a> 
              </td>    
          </tr>
          <?php $id += 1; ?>
          @endforeach
